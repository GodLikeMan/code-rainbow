			...
			<div id = "itemTags">
				...
				<?php 
					...
					while($row = $result->fetchArray()) {
							$tagListHtml .= '<li class="tag-list-item"><h4><span class="label label-primary"><i class="fa fa-arrows"></i> '.$row['data'].'</span></h4></li>';
							$tagNum++;	
					}
					...
					if($tagNum < 10){
						echo '<li class="tagInputSet"><div class="input-group input-group-sm"> <span class="input-group-btn"><button class="btn btn-default" type="submit"><i class="fa fa-check"></i></button></span><input  id="tagDataInput" class="form-control" type="text" maxlength="30" required placeholder="Add new tag"></div></li>';
						echo '<li class="tagInputSet"><input id="editSku" type="hidden" value="'.$_GET['sku'].'" ></li>';
					}
					echo "</ul></form>";
					echo '<button id="end-edit-tag" class="btn btn-default pull-right" type="button"><i class="fa fa-undo"></i>  End Edit Tag</button>';
				?>
				</div>
